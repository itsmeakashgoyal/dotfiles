...
local options = {
    ...
    completeopt = {"menuone", "noselect", "popup"}, -- popup: preview via completionItem/resolve
    autocomplete = true, -- native LSP completion (Neovim 0.12+) auto-triggers on insert
    conceallevel = 0, -- so that `` is visible in markdown files
    encoding = "utf-8",
    fileencoding = "utf-8", -- the encoding written to a file
    hlsearch = true, -- highlight all matches on previous search pattern
    ignorecase = true, -- ignore case in search patterns
    mouse = "", -- allow the mouse to be used in neovim or '' to use copy
