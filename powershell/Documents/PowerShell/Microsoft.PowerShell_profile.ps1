...
# Mirrors mkvenv/rmvenv/venv in zsh/.config/zsh/conf.d/08-python.zsh - same
# names, same defaults, same behavior, so the workflow in docs/PYTHON.md is
# identical on every platform. mise (above) still decides which Python
# interpreter uv uses.
# ==============================================================================
